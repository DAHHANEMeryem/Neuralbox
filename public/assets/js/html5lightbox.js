...
function loadHtml5LightBox(jsFolder) {
    (function ($) {
        $.fn.html5lightbox = function (options) {
            ...
            inst.options.isIE =
                ...
                !inst.options.isOpera;
            inst.options.isIE10 =
                navigator.userAgent.match(/MSIE 10/i) != null &&
                !this.options.isOpera;
            inst.options.isIE9 =
                navigator.userAgent.match(/MSIE 9/i) != null &&
                !inst.options.isOpera;
            inst.options.isIE8 =
                navigator.userAgent.match(/MSIE 8/i) != null &&
                !inst.options.isOpera;
            inst.options.isIE7 =
                navigator.userAgent.match(/MSIE 7/i) != null &&
                !inst.options.isOpera;
            inst.options.isIE6 =
                navigator.userAgent.match(/MSIE 6/i) != null &&
                !inst.options.isOpera;
            ...
            inst.createMarkup = function () {
                if (
                    $(window).width() <= inst.options.fullscreensmallscreenwidth
                ) {
                ...
                if (inst.options.titlecss.length > 1) {
                    if (inst.options.titlecss.charAt(0) == "{")
                        inst.options.titlecss =
                            inst.options.titlecss.substring(1);
                    if (
                        inst.options.titlecss.charAt(
                ...
                inst.options.descriptioncss = $.trim(
                    inst.options.descriptioncss
                );
                if (inst.options.descriptioncss.length > 1) {
                    ...
                    if (
                        ...
                        inst.options.descriptioncss =
                            inst.options.descriptioncss.substring(
                                0,
                                inst.options.descriptioncss.length - 1
                            );
                }
                ...
                if (inst.options.errorcss.length > 1) {
                    if (inst.options.errorcss.charAt(0) == "{")
                        inst.options.errorcss =
                            inst.options.errorcss.substring(1);
                    if (
                        inst.options.errorcss.charAt(
                    ...
                    if (inst.options.titlestyle == "inside")
                        ...
                        inst.$elemWrap.css({
                            "border-top-left-radius":
                                inst.options.borderradius + "px",
                            "-moz-top-left-border-radius":
                                inst.options.borderradius + "px",
                            "-webkit-top-left-border-radius":
                                inst.options.borderradius + "px",
                            "border-top-right-radius":
                                inst.options.borderradius + "px",
                            "-moz-top-right-border-radius":
                                inst.options.borderradius + "px",
                ...
                if (inst.options.showsocial) {
                    ...
                    if (inst.options.showfacebook)
                        socialCode +=
                            ...
                            (inst.options.socialrotateeffect
                                ? " html5-rotate"
                                : "") +
                ...
                if (inst.options.fullscreenmode) {
                    ...
                    inst.$nextbottom = $(
                        ".html5-next-bottom-fullscreen",
                        inst.$lightbox
                    );
                    inst.$prevbottom = $(
                        ".html5-prev-bottom-fullscreen",
                        inst.$lightbox
                    );
                ...
                if (inst.options.closeonoverlay)
                    $("#html5-lightbox-overlay", inst.$lightbox).click(
                        inst.finish
                    );
                ...
                this.resume = function (forceresume) {
                    ...
                    if (started && paused) {
                        ...
                        updateTimerId = setInterval(function () {
                            ...
                            if (updatecallback)
                                updatecallback(
                                    runningTime / timerInstance.timeout
                                );
                        }, updateinterval);
                    }
                };
            ...
            inst.prevArrowClicked = function () {
                if (inst.options.prevElem >= inst.options.curElem)
                    if (
                        ...
                        typeof window[inst.options.onfirstarrowclicked] ==
                            "function"
                    )
                        window[inst.options.onfirstarrowclicked]();
                inst.gotoSlide(-2);
            ...
            inst.calcNextPrevElem = function () {
                ...
                if (curGroup != undefined && curGroup != null) {
                    for (
                        j = inst.options.curElem + 1;
                        j < inst.elemArray.length;
                        j++
                    )
                        if (
                            inst.matchGroup(
            ...
            inst.calcBoxPosition = function (initW, initH) {
                ...
                var winH = window.innerHeight
                    ...
                    : $(window).height();
                var boxT = Math.round(
                    (winH - inst.options.navheight) / 2 - boxH / 2
                );
            ...
            inst.showNavigation = function () {
                ...
                $navPrev.click(function () {
                    ...
                    var marginLeft =
                        parseInt($navList.css("margin-left")) + maskWidth;
                    if (marginLeft >= 0) {
                        marginLeft = 0;
                ...
                if (inst.options.totalwidth <= winWidth) {
                    ...
                    $navMask.css({
                        width:
                            winWidth - 2 * inst.options.navbuttonwidth + "px",
                    });
                    $navPrev.show();
                    $navNext.show();
                }
            ...
            (inst.showTitle = function (w, t, description) {
                ...
                if (
                    ...
                    text +=
                        '<p class="html5-description">' + description + "</p>";
                inst.$text.html(text);
            ...
            inst.resizeWindow = function () {
                ...
                if (
                    ...
                    if (
                        inst.currentElem[ELEM_TYPE] == 7 &&
                        $("#html5lightbox-web-iframe", inst.$lightbox).length >
                            0 &&
                        $("#html5lightbox-web-iframe", inst.$lightbox).data(
                            "sameoriginloaded"
                        )
    ...
    .animate({ opacity: 1 }, {
        ...
        step: function (now, fx) {
            if (fx.prop === "opacity") {
                var scale = 0.9 + 0.1 * now; // Animate scale from 0.9 to 1
                inst.$lightboxBox.css("transform", "scale(" + scale + ")");
            }
        },
        complete: function () {
            inst.$lightboxBox.css("transform", "scale(1)");
        ...
        complete: function () {
            ...
            inst.finish = function () {
                ...
                $("head")
                    ...
                    .each(function () {
                        if (
                            $(this).data("creator") == "html5box-html5-lightbox"
                        )
                            $(this).remove();
                    });
                inst.slideTimeout.stop();
        ...
        $.fn.lightboxHTML5VideoControls = function (
            ...
            if (
                ...
                var switchScreenCSS = function (fullscreen) {
                    ...
                    var backgroundPosY = $videoFullscreen.css(
                        "background-position"
                    )
                        ? $videoFullscreen
