        ...
        setup: function () {
            if (this.addEventListener)
                for (var c = h.length; c; )
                    this.addEventListener(h[--c], b, { passive: true });
                ...
                n.advanced.autoExpandHorizontalScroll &&
                    ...
                    i
                        ...
                        .css({
                            width:
                                Math.ceil(
                                    i[0].getBoundingClientRect().right + 0.4
                                ) -
                    ...
                    if (ee(e) && !c && !I(e)[2]) {
                        ...
                        if (!(g - p > 30)) {
                            ...
                            var n = "mcsEaseOut",
                                i = 2.5 > x,
                                r = i
                                    ? [R[R.length - 2], D[D.length - 2]]
                                    : [0, 0];
                            v = i ? [o - r[0], a - r[1]] : [o - f, a - h];
                            var d = [Math.abs(v[0]), Math.abs(v[1])];
                            x = i
                                ? [Math.abs(v[0] / 4), Math.abs(v[1] / 4)]
                                : [x, x];
                            var u = [
                ...
                l.bind(
                    ...
                    .bind("click." + n, function (a) {
                        if (
                            ...
                            if (
                                n.parent(".mCSB_scrollTools_horizontal")
                                    .length > 0
                            ) {
