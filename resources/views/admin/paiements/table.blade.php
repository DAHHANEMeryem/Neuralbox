<table class="min-w-full border-collapse rounded-lg overflow-hidden shadow-lg">
    <thead class="bg-gradient-to-r from-indigo-500 to-indigo-700 text-white">
        <tr>
            ...
            <th class="px-1 md:px-6 py-2 md:py-3 text-center font-semibold">Utilisateur</th>
            <!-- <th class="px-6 py-3 text-center font-semibold">Status</th> -->
            <!-- <th class="px-6 py-3 text-center font-semibold">Méthode</th>-->
            <th class="px-1 md:px-6 py-2 md:py-3 text-center font-semibold">Statut</th>
            <th class="px-1 md:px-6 py-2 md:py-3 text-center font-semibold">Date</th>
    ...
    <tbody class="bg-white">
        ...
        <tr onclick="goto(`{{route('subscriptions.show',$paiement->id)}}`)" class="border-b cursor-pointer hover:bg-indigo-50 transition-colors duration-200">
            ...
            <td class="px-2 md:px-6 py-1 md:py-4 text-sm text-center text-gray-700">{{ $paiement->user->name ?? 'N/A' }}</td>
            ...
            <td class="px-2 md:px-6 py-1 md:py-4 text-sm text-center font-semibold">
            ...
            <td class="md:px-6 md:py-4 text-center text-gray-500">{{ $paiement->created_at->format('d/m/Y') }}</td>
            <td class="md:px-6 md:py-4 text-center text-gray-500"><a href="{{ route('admin.subscription_edit',$paiement) }}" class="p-2"><i class="fa fa-pen text-green-500"></i></a></td>
        </tr>
        @empty
        <tr>
