      ...
      <div class="section-content open">
        ...
        <div class="lesson-item">
          <details class="tool-item">
            ...
            <div class="video" style="position: relative;">
              <img src="{{ asset('/' . $ressource->preview_image) }}" alt="Aperçu vidéo" class="preview-image" />
        ...
        <details class="tool-item">
          ...
          <div class="video-wrapper">
            <div class="video" id="video-container" style="position: relative;">
              <img src="{{ asset('/' . $ressource->preview_image) }}" alt="Aperçu vidéo" class="preview-image" style="cursor: pointer; width: 100%;" onclick="{{ $estAbonne ? '' : 'showPopup()' }}" />
