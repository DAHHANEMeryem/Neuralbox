      ...
      <div class="section-content open">
        ...
        <div class="lesson-item">
          <details class="tool-item">
            ...
            <div class="video" style="position: relative;">
              <img src="{{ asset('images/' . $ressource->preview_image) }}" alt="Aperçu vidéo" class="preview-image" />
              <a href="javascript:void(0)" data-video="{{ $ressource->video_url }}" class="open-video overlay-box">
                <span class="icon flaticon-play-arrow"><i class="ripple"></i></span>
              </a>
              <video controls style="display: none;">
                <source src="{{ asset('videos/' . $ressource->video_url) }}" type="video/mp4">
              </video>
            </div>
          </details>
        </div>
        ...
        <details class="tool-item">
          ...
          <div class="video-wrapper">
            <div class="video" id="video-container" style="position: relative;">
              <img src="{{ asset('images/' . $ressource->preview_image) }}" alt="Aperçu vidéo" class="preview-image" style="cursor: pointer; width: 100%;" onclick="{{ $estAbonne ? '' : 'showPopup()' }}" />
...
<div id="shareModal" class="share-modal">
  <div class="share-modal-content">
    ...
    <div class="copy-link">
      <input type="text" id="courseLink" value="{{ url('/peda') }}" readonly>
