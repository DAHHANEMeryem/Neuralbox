...
class RessourceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Ressource::create([
           'titre' => 'الفرق بين الانتباه والتركيز',
                ...
                'video_url' => 'تعريفالانتباهوالتركيز.mp4',
                'categorie' => 'pedagogie',
                'visibilite' => 'tous',
    ...
    Ressource::create([
            'titre' => 'أنواع التركيز و الانتباه',
                ...
                'video_url' => 'أنواعالتركيزوالانتباه.mp4',
                'categorie' => 'pedagogie',
                'visibilite' => 'tous',
                'preview_image' => 'images/peda/2.jpg',
                'ordre' => 2,
        ]);
            Ressource::create([
           'titre' => 'اضطراب فرط الحركة و تشتت الانتباه',
                ...
                'video_url' => 'تشتتالانتباه.mp4', // Remplacez avec le vrai nom de fichier si disponible
                'categorie' => 'pedagogie',
                'visibilite' => 'abonne',
                'preview_image' => 'images/MrAbdessamad_video_covers-01.jpg',
                'ordre' => 3,
        ]);
            Ressource::create([
            'titre' => 'التمييز بين اضطراب فرط الحركة وتشتت الانتباه ومشكل فرط الحركة و تشتت الانتباه',
                ...
                'video_url' => 'تشتتالانتباه.mp4',
                'categorie' => 'pedagogie',
                'visibilite' => 'abonne',
                'preview_image' => 'images/peda/3.jpg',
                'ordre' => 4,
        ]);
            Ressource::create([
           'titre' => 'تقدير الذات',
           ...
           'titre' => 'قيم النجاح الستة',
            ...
            'titre' => 'الركائز السبع للتعلم',
                ...
                'video_url' => 'الركائزالسبعللتعلم.mp4',
                'categorie' => 'pedagogie',
                'visibilite' => 'abonne',
                'preview_image' => 'images/MrAbdessamad_video_covers-04.jpg',
                'ordre' => 11,
       ...
       Ressource::create(['titre' => 'الأداة الأولى – ميكادو',
              ...
              Ressource::create([ 'titre' => 'الأداة الثانية – الهلال',
                ...
                'video_url' => 'Tool2-Hilal.mp4',
                'categorie' => 'neuralbox',
                'visibilite' => 'tous',
                'preview_image' => 'images/MrAbdessamad_video_covers-02.jpg',
                'ordre' => 2,
                'created_at' => $now,
                'updated_at' => $now
