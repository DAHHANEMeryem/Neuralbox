...
class DashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        $nombre_parents =  User::whereNot('is_admin', false)->count();
        $totalRdv = RendezVous::count();
        ...
        $filtre = $request->input('filtre', 'annee');
        ...
        return view('admin.dashboard', [
            ...
            'revenus_mois' => Paiement::whereMonth('created_at', now()->month)->where('status', 'validated')->sum('montant'),
